  ...
  return (
    ...
    >
        <div className='min-h-[30vh] flex flex-col text-center lg:flex-start items-center justify-center mt-20 mb-32 w-[85%] md:leading-8 md:w-[70%] xl:w-full xl:ml-[10%] gap-2'>
            ...
            <p className='text-sm md:text-3xl lg:text-start lg:text-[20px] lg:w-[70%] lg:self-start lg:leading-[24px]'>Más que un servicio, ofrecemos soluciones personalizadas para tu situación</p>
