  ...
  return (
    <>
        ...
        <section className='py-6 px-12 md:px-20 lg:px-40 xl:px-60 lg:pt-24'>
          ...
          <h3 className='text-3xl mb-4 mt-8'>Cookies propias</h3>
          ...
          <h3 className='text-3xl mb-4 mt-8'>Cookies de redes sociales</h3>
          <p>
          ...
          <h3 className='text-3xl mb-4 mt-8'>Registro de Datos de Carácter Personal</h3>
          ...
          <h3 className='text-3xl mb-4 mt-8'>Deshabilitar, rechazar y eliminar cookies</h3>
