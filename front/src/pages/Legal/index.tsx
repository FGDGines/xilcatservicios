    ...
    <>
        ...
        <section className='py-6 px-12 md:px-20 lg:px-40 xl:px-60 lg:pt-24' >
            ...
            <div className='1px border border-cs-purple w-[5%] m-auto'></div>
                ...
                <h4 className='text-xl font-semibold mb-2'>I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Leyes que incorpora esta política de privacidad</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Identidad del responsable del tratamiento de los datos personales</h4>
            <p>
            ...
            <h4 className='text-lg font-semibold my-2'>Registro de Datos de Carácter Personal</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Principios aplicables al tratamiento de los datos personales</h4>
            <h6>El tratamiento de los datos personales del Usuario se someterá a los siguientes principios recogidos en el artículo 5 del RGPD y en el artículo 4 y siguientes de la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales:</h6>
            <ul className="list-disc ml-4">
            ...
            <h4 className='text-lg font-semibold my-2'>Categorías de datos personales</h4>
            ...
            <h3 className='text-lg font-semibold my-2'>Base legal para el tratamiento de los datos personales</h3>
            ...
            <h4 className='text-lg font-semibold my-2'>Fines del tratamiento a que se destinan los datos personales</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Períodos de retención de los datos personales</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Destinatarios de los datos personales</h4>
            <p>Los datos personales del Usuario serán compartidos con los siguientes destinatarios o categorías de destinatarios:</p>
            <p>XILCAT SERVICIOS, Con Dirección en la Calle Joan Güell 184 - Nou boulevard, Despacho 25, Barcelona- CP: 08028</p>
            ...
            <h4 className='text-lg font-semibold my-2'>Datos personales de menores de edad</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Secreto y seguridad de los datos personales</h4>
            <p>Gestoría xilcat servicios se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel de seguridad adecuado al riesgo de los datos recogidos, de forma que se garantice la seguridad de los datos de carácter personal y se evite la destrucción, pérdida o alteración accidental o ilícita de datos personales transmitidos, conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos datos.</p>
            ...
            <h4 className='text-lg font-semibold my-2'>Derechos derivados del tratamiento de los datos personales</h4>
            ...
            <ul className="list-disc ml-4">
                ...
                <li>Derecho de oposición: Es el derecho del Usuario a que no se lleve a cabo el tratamiento de sus datos de carácter personal o se cese el tratamiento de los mismos por parte de Gestoria xilcat servicios.</li>
                <li>Derecho a no ser objeto de una decisión basada únicamente en el tratamiento automatizado, incluida la elaboración de perfiles: Es el derecho del Usuario a no ser objeto de una decisión individualizada basada únicamente en el tratamiento automatizado de sus datos personales, incluida la elaboración de perfiles, existente salvo que la legislación vigente establezca lo contrario.</li>
            </ul>
            <h6>Así pues, el Usuario podrá ejercitar sus derechos mediante comunicación escrita dirigida al Responsable del tratamiento con la referencia "RGPD-www.xilcatservicios.com", especificando:</h6>
            <ul className="list-disc ml-4">
            ...
            <h6>Esta solicitud y todo otro documento adjunto podrá enviarse a la siguiente dirección y/o correo electrónico:
            ...
            <h4 className='text-lg font-semibold my-2'>Enlaces a sitios web de terceros</h4>
            ...
            <h4 className='text-lg font-semibold my-2'>Reclamaciones ante la autoridad de control</h4>
            <p>En caso de que el Usuario considere que existe un problema o infracción de la normativa vigente en la forma en la que se están tratando sus datos personales, tendrá derecho a la tutela judicial efectiva y a presentar una reclamación ante una autoridad de control, en particular, en el Estado en el que tenga su residencia habitual, lugar de trabajo o lugar de la supuesta infracción. En el caso de España, la autoridad de control es la Agencia Española de Protección de Datos (https://www.aepd.es/).</p>
            <h4 className='text-2xl font-semibold my-2'>II. ACEPTACIÓN Y CAMBIOS EN ESTA POLÍTICA DE PRIVACIDAD</h4>
